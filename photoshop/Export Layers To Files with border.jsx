...
/*
@@@BUILDINFO@@@ Export Layers To Files with border.jsx 1.0.0.13
*/
...
<javascriptresource>
<name>$$$/JavaScripts/ExportLayersToFilesWithBorderWithBorder/Menu=Export Layers to Files with border...</name>
<about>$$$/JavaScripts/ExportLayersToFilesWithBorderWithBorder/About=Export Layers to Files with border^r^rCopyright 2007-2008 Adobe Systems Incorporated. All rights reserved.^r^rExports each layer to an individual file with the border layer.</about>
<category>layers</category>
<enableinfo>true</enableinfo>
<eventid>6f1c2cf5-4a97-4e32-8f59-f5d7a087adef</eventid>
<terminology><![CDATA[<< /Version 1 
                         /Events << 
                          /6f1c2cf5-4a97-4e32-8f59-f5d7a087adef [($$$/JavaScripts/ExportLayersToFilesWithBorderWithBorder/Action=Export Layers to Files) /noDirectParam <<
...
var strTitle = localize("$$$/JavaScripts/ExportLayersToFilesWithBorder/Title=Export Layers To Files");
var strButtonRun = localize("$$$/JavaScripts/ExportLayersToFilesWithBorder/Run=Run");
var strButtonCancel = localize("$$$/JavaScripts/ExportLayersToFilesWithBorder/Cancel=Cancel");
var strHelpText = localize("$$$/JavaScripts/ExportLayersToFilesWithBorder/Help=Please specify the format and location for saving each layer as a file.");
var strLabelDestination = localize("$$$/JavaScripts/ExportLayersToFilesWithBorder/Destination=Destination:");
var strButtonBrowse = localize("$$$/JavaScripts/ExportLayersToFilesWithBorder/Browse=&Browse...");
var strLabelFileNamePrefix = localize("$$$/JavaScripts/ExportLayersToFilesWithBorder/FileNamePrefix=File Name Prefix:");
var strCheckboxVisibleOnly = localize("$$$/JavaScripts/ExportLayersToFilesWithBorder/VisibleOnly=&Visible Layers Only");
var strLabelFileType = localize("$$$/JavaScripts/ExportLayersToFilesWithBorder/FileType=File Type:");
var strCheckboxIncludeICCProfile = localize("$$$/JavaScripts/ExportLayersToFilesWithBorder/IncludeICC=&Include ICC Profile");
var strJPEGOptions = localize("$$$/JavaScripts/ExportLayersToFilesWithBorder/JPEGOptions=JPEG Options:");
var strLabelQuality = localize("$$$/JavaScripts/ExportLayersToFilesWithBorder/Quality=Quality:");
var strPSDOptions = localize("$$$/JavaScripts/ExportLayersToFilesWithBorder/PSDOptions=PSD Options:");
var strCheckboxMaximizeCompatibility = localize("$$$/JavaScripts/ExportLayersToFilesWithBorder/Maximize=&Maximize Compatibility");
var strTIFFOptions = localize("$$$/JavaScripts/ExportLayersToFilesWithBorder/TIFFOptions=TIFF Options:");
var strLabelImageCompression = localize("$$$/JavaScripts/ExportLayersToFilesWithBorder/ImageCompression=Image Compression:");
var strNone = localize("$$$/JavaScripts/ExportLayersToFilesWithBorder/None=None");
var strPDFOptions = localize("$$$/JavaScripts/ExportLayersToFilesWithBorder/PDFOptions=PDF Options:");
var strLabelEncoding = localize("$$$/JavaScripts/ExportLayersToFilesWithBorder/Encoding=Encoding:");
var strTargaOptions = localize("$$$/JavaScripts/ExportLayersToFilesWithBorder/TargaOptions=Targa Options:");
var strLabelDepth = localize("$$$/JavaScripts/ExportLayersToFilesWithBorder/Depth=Depth:");
var strRadiobutton16bit = localize("$$$/JavaScripts/ExportLayersToFilesWithBorder/Bit16=16bit");
var strRadiobutton24bit = localize("$$$/JavaScripts/ExportLayersToFilesWithBorder/Bit24=24bit");
var strRadiobutton32bit = localize("$$$/JavaScripts/ExportLayersToFilesWithBorder/Bit32=32bit");
var strBMPOptions = localize("$$$/JavaScripts/ExportLayersToFilesWithBorder/BMPOptions=BMP Options:");
var strAlertSpecifyDestination = localize("$$$/JavaScripts/ExportLayersToFilesWithBorder/SpecifyDestination=Please specify destination.");
var strAlertDestinationNotExist = localize("$$$/JavaScripts/ExportLayersToFilesWithBorder/DestionationDoesNotExist=Destination does not exist.");
var strTitleSelectDestination = localize("$$$/JavaScripts/ExportLayersToFilesWithBorder/SelectDestination=Select Destination");
var strAlertDocumentMustBeOpened = localize("$$$/JavaScripts/ExportLayersToFilesWithBorder/OneDocument=You must have a document open to export!");
var strAlertNeedMultipleLayers = localize("$$$/JavaScripts/ExportLayersToFilesWithBorder/NoLayers=You need a document with multiple layers to export!");
var strAlertWasSuccessful = localize("$$$/JavaScripts/ExportLayersToFilesWithBorder/Success= was successful.");
var strUnexpectedError = localize("$$$/JavaScripts/ExportLayersToFilesWithBorder/Unexpected=Unexpected error");
var strMessage = localize("$$$/JavaScripts/ExportLayersToFilesWithBorder/Message=Export Layers To Files action settings");
var	stretQuality = localize( "$$$/locale_specific/JavaScripts/ExportLayersToFilesWithBorder/ETQualityLength=30" );
var	stretDestination = localize( "$$$/locale_specific/JavaScripts/ExportLayersToFilesWithBorder/ETDestinationLength=160" );
var	strddFileType = localize( "$$$/locale_specific/JavaScripts/ExportLayersToFilesWithBorder/DDFileType=100" );
var	strpnlOptions = localize( "$$$/locale_specific/JavaScripts/ExportLayersToFilesWithBorder/PNLOptions=100" );
var strPNG8Options = localize("$$$/JavaScripts/ExportLayersToFilesWithBorder/PNG8Options=PNG-8 Options:");
var strCheckboxPNGTransparency = localize("$$$/JavaScripts/ExportLayersToFilesWithBorder/Transparency=Transparency");
var strCheckboxPNGInterlaced = localize("$$$/JavaScripts/ExportLayersToFilesWithBorder/Interlaced=Interlaced");
var strCheckboxPNGTrm = localize("$$$/JavaScripts/ExportLayersToFilesWithBorder/Trim=Trim Layers");
var strPNG24Options = localize("$$$/JavaScripts/ExportLayersToFilesWithBorder/PNG24Options=PNG-24 Options:");
...
function setInvisibleAllArtLayers(obj) {
    for( var i = 0; i < obj.artLayers.length; i++) {
        ...
        if (obj.artLayers[i].name == "border") {
...
function removeAllInvisibleArtLayers(obj) {
    for( var i = obj.artLayers.length-1; 0 <= i; i--) {
        try {
            if(!obj.artLayers[i].visible && obj.artLayers[i].name != "border") {
...
function exportChildren(dupObj, orgObj, exportInfo, dupDocRef, fileNamePrefix) {
    for( var i = 0; i < dupObj.artLayers.length; i++) {
        ...
        if (orgObj.artLayers[i].name == "border") continue;
